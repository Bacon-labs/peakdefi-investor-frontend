...
declare var $: any;
@Component({
  selector: 'app-fund-trade-history',
  templateUrl: './fund-trade-history.component.html'
})

export class FundTradeHistoryComponent extends ApolloEnabled implements OnInit {
