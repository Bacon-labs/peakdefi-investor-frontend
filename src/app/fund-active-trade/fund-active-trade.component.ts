...
@Component({
  selector: 'app-fund-active-trade',
  templateUrl: './fund-active-trade.component.html'
})
export class FundActiveTradeComponent extends ApolloEnabled implements OnInit {
